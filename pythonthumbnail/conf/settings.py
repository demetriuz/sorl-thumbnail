...
# Backend
THUMBNAIL_BACKEND = 'pythonthumbnail.base.ThumbnailBackend'

# Key-value store, ships with:
# pythonthumbnail.kvstores.cached_db_kvstore.KVStore
# pythonthumbnail.kvstores.redis_kvstore.KVStore
# Redis requires some more work, see docs
THUMBNAIL_KVSTORE = 'pythonthumbnail.kvstores.cached_db_kvstore.KVStore'

# Change this to something else for MSSQL
THUMBNAIL_KEY_DBCOLUMN = 'key'

# Engine, ships with:
# pythonthumbnail.engines.convert_engine.Engine
# pythonthumbnail.engines.pil_engine.Engine
# pythonthumbnail.engines.pgmagick_engine.Engine
# convert is preferred but requires imagemagick or graphicsmagick, se docs
THUMBNAIL_ENGINE = 'pythonthumbnail.engines.pil_engine.Engine'
...
THUMBNAIL_STORAGE = 'pythonthumbnail.storage.Storage'  # settings.DEFAULT_FILE_STORAGE
...
# This means pythonthumbnail will generate and serve a generated dummy image
